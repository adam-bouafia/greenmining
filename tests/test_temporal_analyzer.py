...
from greenmining.analyzers.temporal_analyzer import TemporalAnalyzer, TemporalMetrics, TrendAnalysis
...
class TestTemporalAnalyzer:
    ...
    def test_calculate_period_metrics(self, analyzer, sample_commits, sample_analysis_results):
        ...
        metrics = analyzer.calculate_period_metrics(
            period_key, grouped[period_key], sample_analysis_results
        )
