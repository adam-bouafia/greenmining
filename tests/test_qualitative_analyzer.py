...
class TestQualitativeAnalyzer:
    ...
    def test_calculate_metrics(self, analyzer):
        ...
        analyzer.samples = [
            ValidationSample(
                commit_sha='tp1', commit_message='', code_diff=None,
                repository='', detected_patterns=['caching'],
                detection_method='keyword', true_label=True
            ),
            ValidationSample(
                commit_sha='tp2', commit_message='', code_diff=None,
                repository='', detected_patterns=['async'],
                detection_method='keyword', true_label=True
            ),
            ValidationSample(
                commit_sha='fp1', commit_message='', code_diff=None,
                repository='', detected_patterns=['caching'],
                detection_method='keyword', true_label=False
            ),
            ValidationSample(
                commit_sha='tn1', commit_message='', code_diff=None,
                repository='', detected_patterns=[],
                detection_method='keyword', true_label=False
            ),
            ValidationSample(
                commit_sha='fn1', commit_message='', code_diff=None,
                repository='', detected_patterns=[],
                detection_method='keyword', true_label=True
            ),
        ]
    ...
    def test_get_validation_report(self, analyzer):
        ...
        analyzer.samples = [
            ValidationSample(
                commit_sha='c1', commit_message='', code_diff=None,
                repository='', detected_patterns=['caching'],
                detection_method='keyword', true_label=True,
                validation_status='validated'
            ),
            ValidationSample(
                commit_sha='c2', commit_message='', code_diff=None,
                repository='', detected_patterns=[],
                detection_method='keyword', true_label=None,
    ...
    def test_inter_rater_reliability(self, analyzer):
        ...
        reviewer_a = [
            ...
            ValidationSample(
                commit_sha='c3', commit_message='', code_diff=None,
                repository='', detected_patterns=[],
                detection_method='keyword', true_label=False
            ),
        ]
        ...
        reviewer_b = [
            ValidationSample(
                commit_sha='c1', commit_message='', code_diff=None,
                repository='', detected_patterns=['caching'],
                detection_method='keyword', true_label=True  # Agreement
            ),
            ValidationSample(
                commit_sha='c2', commit_message='', code_diff=None,
                repository='', detected_patterns=['async'],
                detection_method='keyword', true_label=False  # Disagreement
            ),
            ValidationSample(
                commit_sha='c3', commit_message='', code_diff=None,
                repository='', detected_patterns=[],
                detection_method='keyword', true_label=False  # Agreement
            ),
        ]
    ...
    def test_pattern_accuracy_analysis(self, analyzer):
        ...
        analyzer.samples = [
            ...
            ValidationSample(
                commit_sha='c2', commit_message='', code_diff=None,
                repository='', detected_patterns=['caching'],
                detection_method='keyword', true_label=False  # FP
            ),
            ValidationSample(
                commit_sha='c3', commit_message='', code_diff=None,
                repository='', detected_patterns=['async'],
