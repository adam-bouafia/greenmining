...
from greenmining.analyzers.ml_feature_extractor import MLFeatureExtractor, MLFeatures
...
class TestMLFeatureExtractor:
    ...
    def test_extract_features_complete(self, extractor, sample_commit, sample_repository):
        ...
        features = extractor.extract_features(
            sample_commit, sample_repository, all_commits, analysis_results, ground_truth=True
        )
    ...
    def test_extract_features_batch(self, extractor, sample_commit, sample_repository):
