...
class TemporalAnalyzer:
        ...
        return {
            ...
            'summary': {
                ...
                'average_green_rate': round(
                    statistics.mean([p.green_awareness_rate for p in periods]) if periods else 0,
                    2
                ),
            }
        }
    ...
    def _calculate_adoption_curve(self, periods: List[TemporalMetrics]) -> List[Tuple[str, float]]:
        ...
        for period in periods:
            ...
            cumulative_rate = (cumulative_green / cumulative_total * 100) if cumulative_total > 0 else 0
