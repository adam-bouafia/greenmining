...
class QualitativeAnalyzer:
    ...
    def _stratified_sample_by_pattern(
        self,
        results: List[Dict],
        sample_size: int
    ) -> List[Dict]:
        ...
        for data in samples_data:
            ...
            for sample in self.samples:
                if sample.commit_sha == commit_sha:
                    ...
                    sample.validation_status = 'validated' if sample.true_label is not None else 'pending'
                    break
    ...
    def get_validation_report(self) -> Dict:
        ...
        false_positives = [
            ...
            if s.true_label is not None
            and len(s.detected_patterns) > 0
            and not s.true_label
        ]
        ...
        return {
            'sampling': {
                ...
                'validation_progress': round(validated_count / len(self.samples) * 100, 1) if self.samples else 0,
