...
class CommitExtractor:
    ...
    def extract_from_repositories(self, repositories: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        colored_print(f"Settings: max_commits={self.max_commits}, skip_merges={self.skip_merges}, days_back={self.days_back}", "cyan")
    ...
    def _extract_commit_metadata(self, commit, repo_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "branches": list(commit.branches) if hasattr(commit, 'branches') and commit.branches else [],
...
def extract(max_commits: int, skip_merges: bool, days_back: int, repos_file: Optional[str], output: Optional[str], config_file: str):
