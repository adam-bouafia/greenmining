...
echo -e "  Monitor: https://github.com/YOUR_USERNAME/greenmining/actions"
echo ""
...
echo -e "  Docker Hub: https://hub.docker.com/r/YOUR_USERNAME/greenmining/tags"
echo -e "  GHCR:       https://github.com/YOUR_USERNAME/greenmining/pkgs/container/greenmining"
echo ""
